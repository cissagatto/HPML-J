...
hybridPartitions <- function(ds, dataset_name, DsFolders, FolderHClust, FolderHybPart, number_folds){  
  ...
  hybridParalel <- foreach(f = 1:number_folds) %dopar%{  
    ...
    while(p<=num.part){
      ...
      if(totalGroupsPart == 1){
        ...
        while(g<=totalGroupsPart){
          ...
          #SumarioParticoes = rbind(SumarioParticoes, data.frame(dataset_name, fold, numeroDeParticoes, numeroDeGrupos, grupo, rotulosDoGrupo))
    ...
    #SumarioParticoes = rbind(SumarioParticoes, SumarioParticoes2)
    #setwd(Folder)
    #write.csv(SumarioParticoes, "partitions.csv")
    gc()
  } # FIM DO FOR
  gc()
  cat("\n##################################################################################################")
