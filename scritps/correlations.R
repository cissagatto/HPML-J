...
#       correlation matrix                                                                       #
##################################################################################################
computeJaccard <- function(ds, resLS, dataset_name, namesLabels, FolderHC, number_folds){
...
##################################################################################################
CutreeHClust <- function(ds, resLS, dataset_name, namesLabels, FolderHClust, number_folds){
...
##################################################################################################
bestCoefficient <- function(FolderHClust, number_folds){
